...
# US Government Users Restricted Rights - Use, duplication or disclosure restricted by GSA ADP Schedule Contract wi
th IBM Corp.
...
# Loop through all namespaces and delete all helmreleases.helm.bitnami.com CRD resources (backup in case operator f
ails)
